    ...
    static final List<ShredRowMetaData> SHRED_METADATA =
            List.of(
                    ...
                    new ShredRowMetaData(
                            ...
                            TIMESTAMP_VAR),
                    new ShredRowMetaData(
                            "thread", SQLDataType.VARCHAR.notNull(), String.class, THREAD_VAR),
                    new ShredRowMetaData(
                            "logger", SQLDataType.VARCHAR.notNull(), String.class, LOGGER_VAR),
                    new ShredRowMetaData(
                            "level", SQLDataType.VARCHAR.notNull(), String.class, LEVEL_VAR),
    ...
    static final List<ShredRowMetaData> MISFITS_METADATA =
            List.of(
                    new ShredRowMetaData(
                            ...
                            LOG_TABLE_LINE_COL),
                    new ShredRowMetaData(
                            "mesg", SQLDataType.INTEGER, Integer.class, LAST_MATCH_KEY));
